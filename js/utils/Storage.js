...
class Storage {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    if (!this.validateImportedData(data)) {
                        reject(new Error('インポートするデータの形式が正しくありません'));
                        return;
                    }
    ...
    validateImportedData(data) {
        ...
        const requiredKeys = ['projects', 'tasks', 'expenses', 'settings'];
        return requiredKeys.every(key => Array.isArray(data[key]) || typeof data[key] === 'object');
    }
